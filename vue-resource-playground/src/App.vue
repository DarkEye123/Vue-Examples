<template>
  <div id="app">
    ...
    <div class="row mb-3">
      <div class="col-xs-12 col-sm-8 offset-md-2 col-md-6 offset-md-3 ">
        <input type="text" class="form-control" placeholder="try: 'users' or 'customized' for table name" v-model="tablename">
      </div>
    </div>
    <div class="row mb-1">
      <div class="col-xs-12 col-sm-8 offset-md-2 col-md-6 offset-md-3 ">
        <div class="btn btn-primary mr-2" @click=fetchHttp>Fetch Users</div>
        <div class="btn btn-primary" @click=fetchCustom>Fetch Users from table</div>
      </div>
    </div>
    <div class="row">
      <div class="col-xs-12 col-sm-8 offset-md-2 col-md-6 offset-md-3 ">
...
export default {
  ...
  methods: {
    ...
    fetchCustom() {
      this.resource
        .fetchResource({ node: this.tablename })
        .then(response => {
          console.log(response);
          return response.json(); //this is promise too
        })
